...
if not connection_string:
    ...
    numinst=5
    ports=[10001,1002, 10003,10004,10005] #port is dummy now...
    lats=[-35.361, -35.371, -35.374, -35.378, -35.381]
    lons=[149.167, 149.177, 149.177, 149.177, 149.177]
...
arm_and_takeoff(vehicles[2], 10)
arm_and_takeoff(vehicles[3], 10)
arm_and_takeoff(vehicles[4], 10)
